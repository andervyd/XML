...
public class JDOMCreator {
	...
	public Document createXMLDocument(List<Customer> data) {
		...
		for (Customer customer : data) {
			...
			addChildElement(custElement, Customer.JOINED,  dateFormat.format(customer.getJoined()));
		}
		
		return document;
	}

	public Element addChildElement(Element parent, String elementName, String textValue) {
